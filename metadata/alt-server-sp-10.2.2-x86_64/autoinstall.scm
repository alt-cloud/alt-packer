...
("/datetime-installer" action "write" commit #t name "Europe" zone "Europe/Moscow" utc #t)
...
("/net-eth" action "write" name "enp0s3" ipv "4" configuration "dhcp" controlled "etcnet" search "" dns "" computer_name "altlinux" ipv_enabled #t onboot #t)
("/net-eth" action "write" name "ens4" ipv "4" configuration "dhcp" controlled "etcnet" search "" dns "" computer_name "altlinux" ipv_enabled #t onboot #t)
("/net-eth" action "write" name "eth0" ipv "4" configuration "dhcp" controlled "etcnet" search "" dns "" computer_name "altlinux" ipv_enabled #t onboot #t)
("/net-eth" action "write" name "eth1" ipv "4" configuration "dhcp" controlled "etcnet" search "" dns "" computer_name "altlinux" ipv_enabled #t onboot #t)
