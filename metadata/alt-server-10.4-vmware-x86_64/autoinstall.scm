...
("/postinstall/firsttime" run "systemctl enable -now sshd; control sshd-password-auth enabled; control sshd-permit-root-login enabled; systemctl start sshd; systemctl enable --now vmtoolsd")
