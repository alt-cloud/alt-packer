...
;("/editions" language ("ru_RU") action "write" name "edition_server")
;("/editions" language ("ru_RU") action "write" name "edition_server")
...
;("/pkg-size" language ("ru_RU") action "write" lists "edition_server/alt-server-virt-env" language ("ru_RU"))
;("pkg-groups-cleanup" language ("ru_RU") action "write")

("pkg-install-init" action "write")
; Package lists for installation are taken from 'pkg-groups.tar' file:which
